...
},{"base64-js":1,"ieee754":15,"is-array":16}],3:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],4:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],5:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],6:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],7:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],8:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],9:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],10:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],11:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],12:[function(require,module,exports){
'use strict';
...
},{"./define_crc":13,"buffer":2}],13:[function(require,module,exports){
"use strict";
...
},{"./crc1":3,"./crc16":4,"./crc16_ccitt":5,"./crc16_kermit":6,"./crc16_modbus":7,"./crc16_xmodem":8,"./crc24":9,"./crc32":10,"./crc8":11,"./crc8_1wire":12}],15:[function(require,module,exports){
...
module.exports = function () {
	...
	chrome.usb.onDeviceAdded.addListener(function () {
		ow.device.onDeviceAdded.dispatch();
	});
	...
	chrome.usb.onDeviceRemoved.addListener(function (device) {
		if (device && (deviceObject || {})
			.device && device.device === deviceObject.device) {
			ow.device.onDeviceRemoved.dispatch();
		}
	});
	...
	ow.device.reset = function () {
		...
		return ow.device.controlTransfer(transferInfo)
	...
	ow.device.getStatus = function () {
		...
		return ow.device.bulkTransfer(transferInfo)
	...
	ow.key.romCommand = function (match, keyRom, overdrive) {
		...
		if (match) {
			bulkTransferInfo.data = new Uint8Array(keyRom)
				.buffer;
			if (overdrive) {
				index = 0x0069;
			} else {
	...
	ow.key.romMatch = function (keyRom) {
		return ow.key.romCommand(true, keyRom, false);
	};

	ow.key.romMatchOverdrive = function (keyRom) {
		return ow.key.romCommand(true, keyRom, true);
	};
	...
	ow.key.romSkip = function () {
		return ow.key.romCommand(false, null, false);
	};

	ow.key.romSkipOverdrive = function () {
		return ow.key.romCommand(false, null, true);
	};
		...
		return ow.wire.readBit()
			...
			.then(function (cmpIdBit) {
				...
				if (searchObject.idBit !== 1 || searchObject.cmpIdBit !== 1) {
					...
					return ow.wire.writeBit(searchObject.searchDirection)
						.then(function () {
	...
	ow.key.readAll = function (keyRom, overdrive) {
		return ow.wire.setSpeed(false)
			...
			.then(function () {
				if (overdrive) {
					return ow.key.romMatchOverdrive(keyRom);
				} else {
					return ow.key.romMatch(keyRom);
				}
			})
			.then(function () {
	...
	ow.key.writeDiff = function (keyRom, newData, oldData, overdrive) {
		if ((oldData || new Array(0))
			.length < newData.length) {
			return ow.key.readAll(keyRom, overdrive)
...
var getKeyMemory = function (keyRom, retry) {
	...
	return ow.keyReadAll(keyRom, !retry)
		.then(function (data) {
			...
			console.log('Overdrive Memory Read: ' + ((finish - start) / 1000)
				.toFixed(2) + 's');
			masterMemory = data;
...
var pushDiffKeyMemory = function (keyRom, retry) {
	...
	var start = performance.now();
	return ow.keyWriteDiff(keyRom, data, masterMemory, true)
		.then(function () {
			var finish = performance.now();
			console.log('Overdrive Memory Write: ' + ((finish - start) / 1000)
				.toFixed(2) + 's');
			writeMemoryButton.disabled = false;
		});
};
...
var pushRandomKeyMemory = function (keyRom, retry) {
	...
	var start = performance.now();
	return ow.keyWriteAll(keyRom, data, true)
		.then(function () {
			var finish = performance.now();
			console.log('Overdrive Memory Write: ' + ((finish - start) / 1000)
				.toFixed(2) + 's');
